...
Validasi paket Windows dijalankan pada runner `windows-2022` dan parser Windows PowerShell 5.1 yang sama dengan runtime installer. Artifact hanya diterbitkan setelah tes EXE, instalasi service, HTTPS/aset aplikasi, restart dengan sertifikat tetap, serta uninstall service/firewall lulus. Service memakai folder sementara khusus dengan akses LocalService. Kegagalan pemasangan baru mencoba menghapus resource yang dibuat oleh percobaan tersebut dan menyimpan diagnostik; instalasi yang sudah ada tidak dihapus. Ini belum merupakan jaminan kompatibilitas semua komputer; uji Windows aktual tetap diperlukan.

Shortcut desktop installer kini membuka **PENAPRINT-ControlPanel.exe**, panel Windows untuk status service, Mulai, Hentikan, Mulai ulang, dan Buka aplikasi. Perubahan service meminta izin UAC. Panel dikompilasi oleh GitHub Actions; artifact lama tidak memuat panel ini.
